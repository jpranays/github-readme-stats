const icons = {
  ...
  download: `<path fill-rule="evenodd" d="M8 1.75a.75.75 0 01.75.75v6.19l1.72-1.72a.75.75 0 011.06 1.06l-3 3a.75.75 0 01-1.06 0l-3-3a.75.75 0 111.06-1.06l1.72 1.72V2.5A.75.75 0 018 1.75zM3.25 13a.75.75 0 000 1.5h9.5a.75.75 0 000-1.5H3.25z"/>`,
};
